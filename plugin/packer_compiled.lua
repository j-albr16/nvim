...
_G.packer_plugins = {
  ["CopilotChat.nvim"] = {
    ...
    loaded = true,
    path = "/home/scrutycs/.local/share/nvim/site/pack/packer/start/CopilotChat.nvim",
  ...
  ["typst-preview.nvim"] = {
    ...
    loaded = true,
    path = "/home/scrutycs/.local/share/nvim/site/pack/packer/start/typst-preview.nvim",
