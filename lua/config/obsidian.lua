...
local mapping = {
	{
		...
		{ "<leader>ol", "<cmd>:ObsidianBacklinks<CR>", desc = "List Backlinks" },
		{
			"<leader>od",
			":ObsidianDailies<CR>",
			desc = "to open a picker list of daily notes. For example, :ObsidianDailies -2 1",
		},
		...
		},
		{
			...
			desc = "to extract the visually selected text into a new note and link to it.",
		},
		...
		},
		{
			...
			desc = "to create a new note from a template in the templates folder. Selecting from a list using your preferred picker.",
		},
